...
//									.toByteString()).build());
			...
			TradeService tradeService = SpringContext.getBean("tradeService");
			SC_BuyCommodity scBuyCommodity = SC_BuyCommodity.parseFrom(sc.getData());
			Role role = RoleCache.getRoleById(scBuyCommodity.getRoleId());
			tradeService.buyPropCallback(role, scBuyCommodity.getSuccess(), scBuyCommodity.getAbstractProp(),
					scBuyCommodity.getPropType(), scBuyCommodity.getNum(), scBuyCommodity.getSinglePrice());
...
//					.build());
			...
			TradeService tradeService = SpringContext.getBean("tradeService");
			SC_SaleCommodity scSaleCommodity = SC_SaleCommodity.parseFrom(sc.getData());
			Role role = RoleCache.getRoleById(scSaleCommodity.getRoleId());
			tradeService.salePropCallback(role, scSaleCommodity.getSuccess(), scSaleCommodity.getCommodityId());
