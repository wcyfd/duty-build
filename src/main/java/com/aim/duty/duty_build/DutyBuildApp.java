...
public class DutyBuildApp {
	...
	public static void main(String[] args) {
		...
		marketServer.startClient(new ClientHandler(), new InetSocketAddress("127.0.0.1", 10001), WanClientType.TCP);
		...
		// ByteString str =
		// CS_SaleCommodity.newBuilder().setAbstractProp(brick.serialize()).setNum(31)
		// .setPropType(Constant.BRICK).setSinglePrice(18).build().toByteString();
