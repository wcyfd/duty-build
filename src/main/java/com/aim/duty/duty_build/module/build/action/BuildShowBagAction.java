...
import com.aim.duty.duty_build_entity.protobuf.protocal.Build.CS_ShowBag;
import com.aim.game_base.entity.net.base.Protocal.PT;
import com.aim.game_base.navigation.ActionSupport;
import com.google.protobuf.ByteString;
import com.google.protobuf.InvalidProtocolBufferException;

public class BuildShowBagAction implements ActionSupport {
	...
	public void execute(ByteString data, IoSession session) {
		...
		try {
			...
			PT builder = buildService.showBag(role);
			if (session != null) {
